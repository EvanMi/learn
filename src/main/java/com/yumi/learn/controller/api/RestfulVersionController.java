...
public class RestfulVersionController {
	...
	/***
	 * <type>/<tree>.<subtype>+<suffix>[;参数…] 1.
	 * type：application、audio、example、image、message、model、multipart、text、video 2. tree：vnd
	 * 3. subtype：yumi.v[x] 4. suffix：json 5. 参数：charset=utf-8
	 */
